...
if ($role_id['role_id'] === 2): ?>
    ...
    <body id="adminbody">
        ...
        <ul class="menuNav" id="menuNav">
            ...
            <li class="menuNavLi" onclick="getInfoDoc(this)" data-table="pets">Patients</li>
            <li class="menuNavLi" onclick="getInfoDoc(this)" data-table="appointments">Appointments</li>
            <li class="menuNavLi" onclick="getInfoDoc(this)" data-table="medication_reminders">Prescriptions</li>
            <li class="menuNavLi" onclick="getInfoDoc(this)" data-table="medication_reminders" id="hiddenLi">Prescriptions</li>
